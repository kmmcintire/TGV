...
% Simulate model for each parameter combination
    Nvals = zeros(length(betaC),length(rC));
    Thetavals = zeros(length(betaC),length(rC));
    Itotalvals = zeros(length(betaC),length(rC));
    
    for ii=1:length(betaC)
        for jj = 1:length(rC)
            parms = [rS rC(jj) rI rD K mS mC mI mD betaS betaC(ii) chiI chiD u delta];
            x0 = [K,0,0,0,100]; % initial density values
            [t,x] = ode45(@model_NXYZP,times,x0,[],parms);
            Nvals(ii,jj) = x(end,1);
            Thetavals(ii,jj) = x(end,3);
...
%% Panel E: Sensitivity to rD - NEED MAPLE TO EXPORT EQ VALUES
% Model parameter values
    rS = 4;
    rC = 4;
    rI = 2;
    ...
    Curve1 = importdata('NumericalEq/dNdrD_chiD1_Nsave1.txt');
    Parmsave1 = importdata('NumericalEq/dNdrD_chiD1_Nsave1_parm.txt');
    Curve2 = importdata('NumericalEq/dNdrD_chiD3_Nsave1.txt');
    Parmsave2 = importdata('NumericalEq/dNdrD_chiD3_Nsave1_parm.txt');
    Curve3 = importdata('NumericalEq/dNdrD_chiD5_Nsave1.txt');
    Parmsave3 = importdata('NumericalEq/dNdrD_chiD5_Nsave1_parm.txt');
    Curve4 = importdata('NumericalEq/dNdrD_chiD7_Nsave1.txt');
    Parmsave4 = importdata('NumericalEq/dNdrD_chiD7_Nsave1_parm.txt');
    Curve5 = importdata('NumericalEq/dNdrD_chiD9_Nsave1.txt');
    Parmsave5 = importdata('NumericalEq/dNdrD_chiD9_Nsave1_parm.txt');
...
% Model parameter values
    ...
    Curve1 = importdata('NumericalEq/dNdchiD_rS4_Nsave1.txt');
    Parmsave1 = importdata('NumericalEq/dNdchiD_rS4_Nsave1_parm.txt');
    Curve2 = importdata('NumericalEq/dNdchiD_rS6_Nsave1.txt');
    Parmsave2 = importdata('NumericalEq/dNdchiD_rS6_Nsave1_parm.txt');
    Curve3 = importdata('NumericalEq/dNdchiD_rS8_Nsave1.txt');
    Parmsave3 = importdata('NumericalEq/dNdchiD_rS8_Nsave1_parm.txt');
    Curve4 = importdata('NumericalEq/dNdchiD_rS10_Nsave1.txt');
    Parmsave4 = importdata('NumericalEq/dNdchiD_rS10_Nsave1_parm.txt');
    Curve5 = importdata('NumericalEq/dNdchiD_rS12_Nsave1.txt');
    Parmsave5 = importdata('NumericalEq/dNdchiD_rS12_Nsave1_parm.txt');
